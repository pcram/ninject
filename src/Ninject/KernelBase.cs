...
#pragma warning restore 612,618
        ...
        {
            var serviveTypeInfo = service.GetTypeInfo();
            return !serviveTypeInfo.IsInterface
                && !serviveTypeInfo.IsAbstract
                && !serviveTypeInfo.IsValueType
                && service != typeof(string)
                && !serviveTypeInfo.ContainsGenericParameters;
        }
